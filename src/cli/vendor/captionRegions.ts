// Vendored for the CLI: captionSegmentsToAnnotationRegions was removed from @/lib/captioning/annotationsFromCaptions in the 1.8 line (the v4 editor renders captions natively). The CLI still writes caption *annotations* into .openscreen projects, so the converter lives on here verbatim.
