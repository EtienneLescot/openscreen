...
*/
		...
		"function" == typeof Object.assign
			...
			: function (a, b) {
					for (var c = 1; c < arguments.length; c++) {
						var d = arguments[c];
						if (d) for (var e in d) Object.hasOwn(d, e) && (a[e] = d[e]);
					}
					return a;
				};
	...
	function lb(a) {
		...
		if (a instanceof Uint8Array)
			return { buffer: new Uint8Array(a.buffer, a.byteOffset, a.byteLength), C: !1 };
		throw Error(
	...
	function P(a, b) {
		...
		Object.defineProperties(a, { A: { value: b, configurable: !0, writable: !0, enumerable: !1 } });
		return b;
	}
	function zb(a, b) {
				...
				case 2:
					...
					if ("object" === typeof window)
						return (
							...
							bd("createMediapipeSolutionsPackedAssets", { locateFile: a.locateFile }),
	...
	function hd(a) {
		...
		return E(function (l) {
			...
			a.D = {};
			if (a.h.listeners)
				for (g = A(a.h.listeners), f = g.next(); !f.done; f = g.next()) (h = f.value), id(a, h);
			k = a.l;
			a.l = {};
			a.setOptions(k);
			l.h = 0;
					...
					if ("detection_list" === r.type) {
						if (p) {
							...
							for (
								...
								za = void 0 === za ? 0 : za;
								T = {
									la: { sa: od, ta: pd, height: qd, width: rd, rotation: sd, pa: Rb(S(T, 6), za) },
		...
		return E(function (e) {
			return "number" === typeof c || c instanceof Uint8Array || c instanceof a.i.Uint8BlobList
				...
				: c instanceof a.i.Texture2dDataOut
					? ((d = a.v[b]), d || ((d = new Wc(a.i, a.K)), (a.v[b] = d)), e.return(Xc(d, c, a.M)))
					: e.return(void 0);
		});
	}
	function id(a, b) {
				...
				m &&
					(a.I = kd(a, k, b.outs).then(function (r) {
						...
						for (var p = 0; p < b.wants.length; ++p) {
							var n = k[d[p]];
							"object" === typeof n && n.hasOwnProperty && Object.hasOwn(n, "delete") && n.delete();
						}
						r && (a.I = r);
					}));
			},
					...
					onChange: function (c) {
						...
						return E(function (f) {
							if (1 == f.h)
								return (
									(d = md(c)),
									(e = "third_party/mediapipe/modules/selfie_segmentation/" + d),
									D(f, gd(b.h, d), 2)
								);
							g = f.i;
