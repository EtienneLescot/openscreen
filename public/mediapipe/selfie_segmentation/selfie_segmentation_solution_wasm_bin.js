var createMediapipeSolutionsWasm = (() => {
	...
	return function (createMediapipeSolutionsWasm) {
		...
		var wasmBinaryFile;
		wasmBinaryFile = "selfie_segmentation_solution_wasm_bin.wasm";
		...
		function getLiveInheritedInstances() {
			...
			for (var k in registeredInstances) {
				if (Object.hasOwn(registeredInstances, k)) {
		...
		function registerInheritedInstance(class_, ptr, instance) {
			...
			if (Object.hasOwn(registeredInstances, ptr)) {
		...
		function runEmAsmFunction(code, sigPtr, argbuf) {
			...
			if (!Object.hasOwn(ASM_CONSTS, code)) abort("No EM_ASM constant found at address " + code);
		...
		var ___start_em_js = (Module["___start_em_js"] = 515059);
		var ___stop_em_js = (Module["___stop_em_js"] = 515579);
